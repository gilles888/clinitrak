package be.clinitrak.ethics.security;
...
/**
 * Service de validation des JWT pour le ethics-service (jjwt 0.12.x).
 *
...
public class JwtService {
     ...
     *
     * @param token token JWT valide
     * @return liste des rôles (ex: ["ROLE_CE_COORDINATOR", "ROLE_ADMIN_TENANT"])
     */
