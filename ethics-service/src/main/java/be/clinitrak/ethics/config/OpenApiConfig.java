...
/**
 * Configuration Springdoc OpenAPI 2.x pour le ethics-service.
 *
...
public class OpenApiConfig {
    ...
    @Value("${spring.application.name:ethics-service}")
    private String appName;

    /**
     * Définit la spécification OpenAPI 3.1 avec sécurité Bearer JWT.
     *
     * @return instance {@link OpenAPI} configurée pour le ethics-service
     */
    @Bean
    public OpenAPI clinitrakOpenAPI() {
        ...
        return new OpenAPI()
            .info(new Info()
                .title("CliniTrak — Ethics Service API")
                .description("Service de gestion du Comité d'Éthique pour la plateforme CliniTrak. " +
                    "Gère les avis éthiques, les réunions, les rapports annuels et la correspondance.")
                .version("1.0.0")
                .contact(new Contact()
            ...
            .servers(List.of(
                new Server().url("http://localhost:8083").description("Dev local"),
