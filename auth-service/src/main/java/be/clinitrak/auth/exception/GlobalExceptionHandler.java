...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Gère les erreurs d'authentification métier (credentials invalides, tenant manquant...).
     *
    ...
    public ResponseEntity<ProblemDetail> handleAuthException(AuthException ex, WebRequest request) {
        ...
        problem.setType(PROBLEM_BASE_URI.resolve("authentication-error"));
    ...
    /**
     * Gère les erreurs d'authentification Spring Security (token manquant...).
     *
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        Map<String, String> fieldErrors = ex.getBindingResult().getFieldErrors().stream()
            .collect(Collectors.toMap(
                ...
                (a, b) -> a // En cas de doublons, on garde le premier
            ));
