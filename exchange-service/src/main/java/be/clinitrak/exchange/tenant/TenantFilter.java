package be.clinitrak.exchange.tenant;
...
/**
 * Filtre de résolution du tenant courant pour le exchange-service.
 *
 ...
 * Le JWT Authentication Filter viendra ensuite l'enrichir avec l'UUID issu du token interne.
 */
@Slf4j
@Component
@Order(1)
