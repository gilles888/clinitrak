...
/**
 * Service de validation des JWT internes pour le exchange-service (jjwt 0.12.x).
 *
 * <p>Valide les tokens émis par l'auth-service en utilisant le secret partagé.
 *
 * <ul>
 ...
 * </ul>
 *
 * @see ExchangeJwtService pour la gestion des JWT des utilisateurs externes
 */
@Slf4j
@Service
public class JwtService {
    ...
    /**
     * Valide un token JWT interne : vérifie la signature et l'expiration.
     *
    ...
    public boolean isTokenValid(String token) {
        try {
            ...
            log.debug("JWT interne invalide : {}", e.getMessage());
            return false;
        }
    }
     ...
     *
     * @param token token JWT valide
     * @return liste des rôles (ex: ["ROLE_CTC_MANAGER", "ROLE_SUPER_ADMIN"])
     */
