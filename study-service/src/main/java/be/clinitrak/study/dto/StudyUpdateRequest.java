...
/**
 * DTO de mise à jour d'une étude clinique.
 *
 * <p>Mêmes contraintes de validation que {@link StudyCreateRequest}.
 * Le statut ne peut être modifié via cet endpoint (utiliser PATCH /status).
 *
 ...
 * @param startDate            date de début prévue ou effective
 * @param endDate              date de fin prévue ou effective
