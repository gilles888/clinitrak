package be.clinitrak.study.security;
...
/**
 * Service de validation des JWT pour le study-service (jjwt 0.12.x).
 *
...
public class JwtService {
     ...
     *
     * @param token token JWT valide
     * @return liste des rôles (ex: ["ROLE_CTC_PM", "ROLE_ADMIN_TENANT"])
     */
