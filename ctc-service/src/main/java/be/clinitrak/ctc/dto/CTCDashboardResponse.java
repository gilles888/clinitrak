 ...
 * @param activeDossiers      dossiers CTC en cours (statuts ASSIGNED + IN_PROGRESS) — widget frontend
 * @param pendingManufacturing demandes desk en statut PENDING non encore assignées — widget frontend
 */
