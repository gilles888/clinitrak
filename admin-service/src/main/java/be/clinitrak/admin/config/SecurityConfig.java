...
import be.clinitrak.admin.security.JwtAuthenticationFilter;
...
/**
 * Configuration Spring Security 6 pour le admin-service (port 8091).
 *
 * <ul>
 ...
 *   <li>Tous les endpoints {@code /api/v1/admin/**} requièrent {@code ROLE_SUPER_ADMIN}</li>
...
public class SecurityConfig {
     ...
     *
     * <p>Tous les endpoints {@code /api/v1/admin/**} nécessitent le rôle
     * {@code ROLE_SUPER_ADMIN}. Les endpoints Swagger et Actuator sont publics.
     *
