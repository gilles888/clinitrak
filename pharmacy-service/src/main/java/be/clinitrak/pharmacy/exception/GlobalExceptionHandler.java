...
/**
 * Gestionnaire global des exceptions REST pour le pharmacy-service.
 *
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Gère les ressources pharmacie non trouvées.
     *
     * @param ex      exception PharmacyNotFoundException
    ...
    public ResponseEntity<ProblemDetail> handlePharmacyNotFoundException(PharmacyNotFoundException ex, WebRequest request) {
        log.warn("Ressource pharmacie non trouvée : {}", ex.getMessage());
        ProblemDetail problem = ProblemDetail.forStatusAndDetail(HttpStatus.NOT_FOUND, ex.getMessage());
        problem.setType(PROBLEM_BASE_URI.resolve("pharmacy-not-found"));
    ...
    /**
     * Gère les violations de règles métier pharmacie (stock insuffisant, état invalide, etc.).
     *
     * @param ex      exception PharmacyException
     * @param request requête web courante
     * @return statut HTTP configuré sur l'exception avec ProblemDetail
     */
    @ExceptionHandler(PharmacyException.class)
    public ResponseEntity<ProblemDetail> handlePharmacyException(PharmacyException ex, WebRequest request) {
        log.warn("Erreur métier pharmacie : {}", ex.getMessage());
        HttpStatus status = ex.getStatus() != null ? ex.getStatus() : HttpStatus.BAD_REQUEST;
        ProblemDetail problem = ProblemDetail.forStatusAndDetail(status, ex.getMessage());
        problem.setType(PROBLEM_BASE_URI.resolve("pharmacy-business-error"));
