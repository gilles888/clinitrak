package be.clinitrak.pharmacy.client;

import be.clinitrak.pharmacy.client.dto.StudyBasicInfo;
...
/**
 * Client Feign pour accéder au study-service depuis le pharmacy-service.
 *
