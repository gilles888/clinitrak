package be.clinitrak.pharmacy.config;
...
/**
 * Configuration Springdoc OpenAPI 2.x pour le pharmacy-service (port 8085).
 *
...
public class OpenApiConfig {
    ...
    @Value("${spring.application.name:pharmacy-service}")
    private String appName;

    /**
     * Définit la spécification OpenAPI 3.1 avec sécurité Bearer JWT.
     *
     * @return instance {@link OpenAPI} configurée pour le pharmacy-service
     */
    @Bean
    public OpenAPI clinitrakOpenAPI() {
        ...
        return new OpenAPI()
            .info(new Info()
                .title("CliniTrak Pharmacy Service")
                .description("Service de gestion de la pharmacie hospitalière pour la plateforme CliniTrak. " +
                    "Gère les médicaments expérimentaux, les stocks, les dispensations, les alertes et la levée de l'insu.")
                .version("1.0.0")
                .contact(new Contact()
